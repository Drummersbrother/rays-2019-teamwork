...
%%%%% USER CONFIGURATION %%%%%
\newcommand{\userName}{Hugo Berg}
\newcommand{\userId}{HB}
\newcommand{\institution}{Rays -- For Excellence -- 2019}
% Added by Hugo Berg
\usepackage{ifthen}
...
\begin{document}
\title{Rays 2019 -- Logbook}
\univlogo
{\Huge Deep Learning}\\[5mm]

\textit{N.B.: The following is a research diary written by \userName  and intends to record the progress and problems encountered by the author during RAYS -- For Excellence -- 2019.}

\vspace{1em}
{\large \underline{\textbf{\uppercase{Novel method on existing datasets}}}}

\section*{Introduction} % (fold)
\label{sec:introduction}
\begin{tip}
This project is, as of today, not very clear in its purpose.\end{tip}
